    ...
    <div className="space-y-5">
      <div className="flex items-center justify-between">
        ...
        <Link href="/dashboard/tenants/new">
          <Button variant="primary" size="sm"><Plus size={14} /> Add tenant</Button>
        </Link>
      </div>
                ...
                <TableRow key={tenant.id}>
                  <TableCell>
                    <div className="flex items-center gap-2.5">
                      ...
                      <Link href={`/dashboard/tenants/${tenant.id}`} className="font-medium text-gray-900 hover:text-teal-700">
                  ...
                  <TableCell>
                    {lease ? <span className="font-medium text-gray-900">${lease.rent_amount}/mo</span> : <span className="text-gray-400">—</span>}
                  </TableCell>
